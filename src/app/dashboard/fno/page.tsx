...
export default function FnoDashboardPage() {
    return (
        <div className="space-y-8 pb-10">
            <div>
                <h1 className="text-2xl font-bold text-foreground mb-2">F&O Dashboard</h1>
                <p className="text-sm text-muted-foreground">Future & Options Market Analysis and Trading Ideas</p>
            </div>
