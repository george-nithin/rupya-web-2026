    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-muted-foreground">Deep dive into market sectors and industries.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="p-4 rounded-xl border border-border bg-card/20 flex items-center justify-center text-muted-foreground text-sm h-[300px]">
