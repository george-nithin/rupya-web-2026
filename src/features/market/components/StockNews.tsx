                ...
                {news.map((item) => (
                    <div key={item.id} className="group cursor-pointer">
                        <div className="flex justify-between items-start gap-3">
                            <div>
                                <h4 className="text-sm text-slate-200 font-medium leading-snug group-hover:text-sky-400 transition-all duration-150">
                                    {item.title}
                                </h4>
                                <div className="flex items-center gap-2 mt-1.5">
                                    <span className="textxs text-muted-foreground flex items-center gap-1">
                        ...
                        <div className="h-px bg-card/20 mt-3 group-last:hidden" />
                    </div>
                ))}
            </div>
        </GlassCard>
