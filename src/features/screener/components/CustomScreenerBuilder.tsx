            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    {conditions.map((condition, index) => {
                        ...
                        return (
                            <div key={condition.id} className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
                                {index > 0 && (
                ...
                {/* Example Hint */}
                <div className="text-xs text-slate-400 bg-sky-500/5 border border-sky-500/20 rounded-lg p-3">
