...
export function MarketStep({ value, onChange }: MarketStepProps) {
    ...
    return (
        <div className="space-y-4">
            <h2 className="text-xl font-bold text-foreground text-center">Which markets do you trade?</h2>
                ...
                {markets.map((market) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="font-semibold text-foreground text-sm">{market.title}</div>
                            <div className="text-xs text-muted-foreground mt-1">{market.description}</div>
                        </GlassCard>
                    );
                })}
            </div>
